public class Hero
{
    ...
    public string Name { get; } // Pour le moment le héro sélectionné à un nom, plus tard ça pourra plutôt être le jour qui à un nom même s'il joue différents archétype
    ...
    // Ctor
    public Hero(string archetype, string name, int hpMax, int con, int str, int dex, int intel, int mainStat, string damages, int ac)
    {
        Archetype = archetype;
        Name = name;
        HpMax = hpMax;
